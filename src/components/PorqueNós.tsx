        ...
        <>
            <div className="flex mx-128 lg:flex-row flex-col justify-center items-center mt-[550px] mb-24">
                <div className="lg:w-1/2 lg:ml-32 m-10">
                    <h1 className="lg:text-3xl text-2xl mb-6 text-roxo font-bold font-Glacial-Bold">Porque escolher a gente?</h1>
                    <h2 className="lg:text-3xl text-lg mb-6 text-laranja font-Montserrat">Venha Realizar Seus Objetivos Conosco</h2>
