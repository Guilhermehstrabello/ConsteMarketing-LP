    ...
    return(
        <>
            ...
            <div className="flex flex-row gap-5 justify-center">
                <div className="w-[350px] h-[450px] bg-white rounded-xl border-2 border-purple-800/50 pt-10 px-5 flex flex-col z-10">
                    ...
                    <p className="text-center mt-5 text-base mb-10">O imbatível buscador continua crescendo. É o site mais visitado da internet, de acordo com o ranking mundial da Alexa, e a principal referência para usuários, empresas e produtores de conteúdo.</p>
                </div>
                <div className="w-[350px] h-[450px] bg-white rounded-xl border-2 border-purple-800/50 pt-10 px-5 flex flex-col z-10">
                    ...
                    <p className="text-center mt-5 text-base mb-12">Deixando para trás o YouTube, o WhatsApp e até seu app de mensagens, o Messenger, o Facebook continua sendo a plataforma social mais forte do mundo.</p>
                </div>
                <div className="w-[350px] h-[450px] bg-white rounded-xl border-2 border-purple-800/50 pt-10 px-5 flex flex-col z-10">
                    ...
                    <p className="text-center mt-5 text-base mb-16">Conteúdos online disponíveis em sites, blogs, plataformas e redes sociais são utilizados por praticamente todos os participantes da pesquisa.</p>
                </div>
            </div>
        </>
    )
