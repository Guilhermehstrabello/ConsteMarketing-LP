...
export default function Rodape() {
    return (
        <>
            <div className="h-[480px] w-full  bg-orange-500">
                <div className="flex flex-row justify-between">
                    <div className="flex flex-col">
                        <img src="/logo.png" alt="Logo Conste Marketing" className="mt-10 ml-24 w-[200px] h-[200px]" />
                ...
                <div className="flex justify-between flex-row mt-10">
                    <div className="flex flex-row gap-7 items-center pl-24 ">
                        <span className="[&>svg]:h-7 [&>svg]:w-7 border-slate-200/15 border-2 p-2 rounded-full">
                            <svg
