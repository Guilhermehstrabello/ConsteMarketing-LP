            ...
            <div ref={rodapeRef} className="lg:h-[480px] w-full bg-laranja">
                <div className="flex lg:flex-row flex-col justify-center lg:gap-96 mx-48">
                    <div ref={logoRef} className="flex flex-col items-center text-lg text-center justify-center">
                        ...
                        <p className="text-white text-base flex flex-col mt-3 hover:underline duration-500"><a href="mailto:eduardo@constemarketing.com.br">contato@constemarketing.com.br</a></p>
                    </div>
                    ...
                    <div ref={socialMediaRef} className="flex flex-col items-center justify-center gap-3">
                        ...
                        <div className="flex flex-row gap-10 items-center mt-10">
                            <a href="https://web.facebook.com/people/Conste-Marketing/61555449532582/" target="_blank" className="[&>svg]:h-7 [&>svg]:w-7 border-slate-200/15 border-2 p-2 rounded-full hover:scale-110 duration-300 hover:bg-cinza">
                                <svg
                            ...
                            <a href="https://www.linkedin.com/company/conste-marketing/" target="_blank" className="[&>svg]:h-7 [&>svg]:w-7 border-slate-200/15 border-2 p-2 rounded-full hover:scale-110 duration-300 hover:bg-cinza">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="white"
                                    viewBox="0 0 448 512">
